        ...
        <div className="max-w-5xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden transform transition-all">
          ...
          <div className="p-8 sm:p-12 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow bg-gray-50 flex flex-col">
              ...
              <div className="border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow bg-gray-50 flex flex-col">
                ...
                <p className="text-gray-600 mb-6 flex-grow">140 Questions (MCQ & SMQ) | 180 Minutes</p>
                <div className="flex flex-col gap-3">
                  <button onClick={() => handleStartExam("B", false)} className="w-full bg-red-600 text-white font-bold py-3 px-6 rounded-full hover:bg-red-700 hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5">
                    Start New
                  </button>
                  {hasSavedSessionB && (
              ...
              <div className="border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow bg-gray-50 flex flex-col">
                ...
                <p className="text-gray-600 mb-6 flex-grow">140 Questions (MCQ & SMQ) | 180 Minutes</p>
                <div className="flex flex-col gap-3">
                  <button onClick={() => handleStartExam("C", false)} className="w-full bg-red-600 text-white font-bold py-3 px-6 rounded-full hover:bg-red-700 hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5">
                    Start New
                  </button>
                  {hasSavedSessionC && (
